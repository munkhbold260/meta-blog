...
export default function Footer() {
  return (
    <div className="w-full h-[495px] m-auto  px-[352px] pt-16 bg-neutral-100 border-t border-gray-200 flex-col  gap-[25px] inline-flex ">
      <div className="m-auto">
        ...
        <div className="w-[1216px] h-[95px] mt-[150px] py-8 border-t border-zinc-200 justify-start items-center gap-16 inline-flex">
          <FooterIcon />
